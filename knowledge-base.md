...
- **Digitakt MK1 sample format:** **16-bit, 48 kHz, mono.** Elektron Transfer converts incoming files to this native format (Digitakt User Manual OS 1.51 p.65). The Digitakt **cannot timestretch** (pitch and speed linked).
...
| **KB v2.6** | **2026-07-19** | **Digitakt format verified:** 16-bit, 48 kHz, mono (Digitakt User Manual OS 1.51 p.65); removed the stale unverified-sample-rate warning. |
