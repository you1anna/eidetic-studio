...
**Menu access:** `[SETTINGS]` (cogwheel) → **MIDI CONFIG** — sub-menus **SYNC** and **PORT CONFIG**. USB personality: `[SETTINGS]` → SYSTEM → USB CONFIG (plain USB MIDI vs Overbridge).
...
- Overbridge mode renames the Ableton MIDI ports — re-apply any Sync/Track toggles to the new port names after switching USB CONFIG.
